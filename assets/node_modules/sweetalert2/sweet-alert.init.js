  ...
  swal.queue(steps).then(function (result) {
    ...
    swal.resetDefaults()
      ...
      swal.queue(steps).then(function (result) {
        ...
        //task-todo- Start
        $(".task-todo-Archive").click(function () {
          Swal.mixin({
              input: 'select',
              confirmButtonText: 'Next &rarr;',
              showCancelButton: true,
          ...
          var steps = [
      {
        title:'You are about to archive tasks.',
        text:'You have 8 active records with this task captured. The task will be released from all records.',
      },
      {
          title: "Are you sure?",
          text: "This can't be undone.",
